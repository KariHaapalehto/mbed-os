...
#define WS_DEFAULT_NETWORK_NAME   "WI-SUN"
...
static char* network_name = WS_DEFAULT_NETWORK_NAME;
...
int8_t wisun_tasklet_network_init(int8_t device_id)
{
    ...
    return arm_nwk_interface_lowpan_init(mac_api, WS_DEFAULT_NETWORK_NAME);
}
